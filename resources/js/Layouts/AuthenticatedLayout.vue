            ...
            <nav class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                        ...
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                <Link :href="route('dashboard')">
                                    <img src="img/AMCLOGO.png" alt="amc logo" class="h-[70px] -my-3.5">
                                </Link>
                            </div>
                            ...
                            <div class="ml-3 relative">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <DropdownLink><div>
                                    <DarkModeSwitch @toggle-dark-mode="toggleDarkMode" />
                                </div></DropdownLink>
                                    </template>
                                </Dropdown>
                            </div>
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink v-if="hasPermission('Landing Page Content')"
                                :href="route('heroes.index')"
                                :active="route().current('heroes.index')">
                                Landing Page
                        </ResponsiveNavLink>
