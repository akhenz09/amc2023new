...
const navigations = [
    ...
    { name: "Hero Header", href: "http://127.0.0.1:8000/heroes" },
    { name: "Partners", href: "http://127.0.0.1:8000/skills" },
    { name: "Programs", href: "http://127.0.0.1:8000/projects" },
    { name: "About Header", href: "http://127.0.0.1:8000/posts" },
];
</script>
...
<aside class="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
    <div class="w-full h-full">
        ...
        <ul class="space-y-2 tracking-wide mt-8">
            ...
            <li>
                <SidebarLink :href="route('heroes.index')"
                :active="route().current('heroes.index')">
                    ...
                    <span class="-mr-1 font-medium">Hero Header</span>
                </SidebarLink>
            </li>
            <li>
                <SidebarLink :href="route('skills.index')"
                :active="route().current('skills.index')">
                    ...
                    <span class="-mr-1 font-medium">Partners</span>
                </SidebarLink>
            </li>
            <li>
                <SidebarLink :href="route('projects.index')"
                :active="route().current('projects.index')">
                    ...
                    <span class="-mr-1 font-medium">Programs</span>
                </SidebarLink>
            </li>
            <li>
                <SidebarLink :href="route('aboutheaders.index')"
                :active="route().current('aboutheaders.index')">
                    <svg class="-ml-1 h-6 w-6" viewBox="0 0 24 24" fill="none">
                        <path d="M6 8a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V8ZM6 15a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2v-1Z" class="fill-current text-cyan-400 dark:fill-slate-600"></path>
                        <path d="M13 8a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2V8Z" class="fill-current text-cyan-200 group-hover:text-cyan-300"></path>
                        <path d="M13 15a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-1Z" class="fill-current group-hover:text-sky-300"></path>
                    </svg>
                    <span class="-mr-1 font-medium">About Headers</span>
                </SidebarLink>
            </li>
...
<div class="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
    <div class="sticky z-10 top-0 h-16 border-b bg-white lg:py-2.5">
            <h5 hidden class="text-2xl text-gray-600 font-medium lg:block">Landing Page Dashboard</h5>
