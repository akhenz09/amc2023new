...
<template>
  <section
    id="home" class="lg:h-[100vh] flex items-center bg-light-primary dark:bg-dark-primary py-32 lg:py-0 overflow-hidden">
    <div class="container mx-auto h-full" v-for="hero in heroes" :key="hero.id">
      <div class="flex flex-col md:flex-row items-center h-full pt-1 ">
        <div class="flex-1 flex flex-col lg:items-start px-26 pt-16">
            <p class="text-lg text-accent text-md mb-[22px]">Hey, I'm Ken! 👋</p>
          <h1
            class="text-4xl leading-[44px] md:text-5xl text-left md:leading-tight lg:text-7xl lg:leading-[1.2] font-bold md:tracking-[-2px]">
          {{ hero.name }}
          </h1>
          <p
